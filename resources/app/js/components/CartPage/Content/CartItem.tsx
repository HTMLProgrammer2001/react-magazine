...
const CartItem: React.FC<ICartItem> = (props) => (
	<div className="table__row">
		<div className="table__col orders__product">
			<img className="orders__img" src={props.product.photo} alt="Product picture"/>
			...
			<div>
				...
				<div className="orders__color">
					...
					<div className="orders__size">{props.product.size}</div>
				</div>
			</div>
		</div>

		<div className="table__col orders__price">{props.product.price}</div>

		<div className="table__col orders__quantity">
			<div className="order__quantity">
				<span className="order__quantity-count"
					  contentEditable="true">{props.count}</span>
			</div>
		</div>

		<div className="table__col orders__total">{props.count * props.product.price}</div>
