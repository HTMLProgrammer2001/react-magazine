...
var CartTable = function (props) { return (React.createElement("div", { className: "container" },
    React.createElement("div", { className: "table__wrap my-pad" },
        React.createElement("div", { className: "table" },
            ...
            React.createElement("div", { className: "table__content" }, props.cartItems.map(function (item, index) { return (React.createElement(CartItem_1.default, __assign({ key: index }, item))); })))),
