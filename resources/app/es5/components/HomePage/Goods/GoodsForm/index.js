...
var GoodsForm = function (props) {
    ...
    return (React.createElement("form", { className: "goods__form", onSubmit: props.handleSubmit },
        ...
        React.createElement("div", { className: "goods__categories" },
            React.createElement(redux_form_1.Field, { component: CheckboxGroup_1.default, name: "categories", formName: props.form, options: ['T1', 'T2', 'T3'] })),
        React.createElement("div", { className: "goods__form-head" }, "Filter by color"),
        React.createElement("div", { className: "goods__color" },
            React.createElement(redux_form_1.Field, { component: ColorGroup_1.default, name: "color", formName: props.form, colors: ['red', 'green', 'yellow', 'black'] })),
        React.createElement("div", { className: "goods__form-head" }, "Filter by size"),
        React.createElement(redux_form_1.Field, { component: SizeGroup_1.default, name: "size", formName: props.form, sizes: ['XS', 'S', 'M', 'L', 'XL'] }),
        React.createElement("div", { className: "goods__form-head" }, "Filter by price"),
        React.createElement(redux_form_1.Field, { component: Slider_1.default, name: "priceRange", formName: props.form, min: 0, max: 1000 }),
